    ...
    <div class="announce">
      <div class="container">
        <div class="announce__text">
          Мой личный список кафе и ресторанов, здесь есть как посещенные места, так и рекоменданнованные мне друзьями и знакомыми. Самые попсовые места типа Шоколадницы или Вкусно и точка практически не включала в список.
        </div>
      </div>
    </div>
